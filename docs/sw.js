    ...
    if (req.mode === 'navigate') {
      event.respondWith((async () => {
        ...
        try {
          ...
          return new Response(`<p style="font-family:system-ui;padding:24px">${"Paulo3D: sem ligação e aplicação ainda não instalada neste aparelho."}</p>`, { status: 503, headers: { 'Content-Type': 'text/html; charset=utf-8' } });
        }
      })());
      return;
    }
